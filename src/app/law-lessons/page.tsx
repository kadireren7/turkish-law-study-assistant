...
import { getLesson, type LessonResult } from '@/lib/api'
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
              Ders alanı ve konu seçin; yerel kaynaklara dayalı, profesör tarzı yapılandırılmış anlatım — özet, kavramlar, kurallar, ayrımlar, örnek olay, sınavda yazım ve kullanılan kaynak.
            </p>
          </div>
          ...
          {content && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Anlatım yerel mevzuat ve konu notlarına (law-data) dayanır; kaynak şeffaflığı için son bölümde kullanılan kaynak listelenir.
              </p>
