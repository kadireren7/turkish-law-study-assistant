...
6. **Program betiği:** Proje klasörünüzdeki `scripts\runners\run-daily-update.bat` dosyasının **tam yolu**
   Örnek: `C:\Users\kadir\Desktop\studylaw\scripts\runners\run-daily-update.bat`
