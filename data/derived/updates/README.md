...
1. **Yerel karşılaştırma:** Script, `data/core/laws/` altındaki dosyaların hash’ini ve madde numaralarını önceki çalıştırmayla karşılaştırır. Değişen dosyalarda eklenen / kaldırılan / değişmiş olabilecek maddeler tespit edilir.
